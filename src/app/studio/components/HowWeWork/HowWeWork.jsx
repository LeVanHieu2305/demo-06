...
function HowWeWork() {
  ...
  return (
    <section className="how-we-work light">
      <div className="container">
        ...
        <div className="items">
          <div className="item">
            ...
            <h3 className="subtitle">Elevating sophistication across all senses</h3>
            <div className="body">
              <p>
          ...
          <div className="item">
            ...
            <h3 className="subtitle">To be human is our greatest quality</h3>
            <div className="body">
              <p>
          ...
          <div className="item">
            ...
            <h3 className="subtitle">Uncompromising standard of excellence</h3>
            <div className="body">
              <p>
